...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create remix-jokes-da3b
  fly apps create remix-jokes-da3b-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app remix-jokes-da3b
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app remix-jokes-da3b-staging
  ```
  ...
  >
  > ```
  > WARN app flag 'remix-jokes-da3b-staging' does not match app name in config file 'remix-jokes-da3b'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the
  ...
  ```sh
  fly postgres create --name remix-jokes-da3b-db
  fly postgres attach --app remix-jokes-da3b remix-jokes-da3b-db

  fly postgres create --name remix-jokes-da3b-staging-db
  fly postgres attach --app remix-jokes-da3b-staging remix-jokes-da3b-staging-db
  ```
